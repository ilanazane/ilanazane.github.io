---
layout: post
title: "Creating a Recommendation System "
date: 2025-02-10
categories: Projects
---
...
We are going to use the <a href="https://grouplens.org/datasets/movielens/" target="_blank"> MovieLens Dataset </a> 
...
We can see that the model performs much better with the new [hyperparameters](## "hyperparameters control how the model is training")! 
